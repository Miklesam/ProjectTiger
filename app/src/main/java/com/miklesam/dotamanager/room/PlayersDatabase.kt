                ...
                .addCallback(object : Callback() {
                    override fun onCreate(db: SupportSQLiteDatabase) {
                        ...
                        scope.launch {
                            ...
                            getInstance(context).noteDao().insertData(PlayersList.VP)
                            getInstance(context).noteDao().insertData(PlayersList.NaVi)
                            getInstance(context).noteDao().insertData(PlayersList.Gambit)
                            getInstance(context).noteDao().insertData(PlayersList.Secret)
                            getInstance(context).noteDao().insertData(PlayersList.ViciGaming)
                            getInstance(context).noteDao().insertData(PlayersList.EG)
